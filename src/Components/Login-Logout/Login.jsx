...
const Login = () => {
  ...
  return (
    <div className="login-background h-screen lg:flex">
      <Link to="/">
        <button className="px-4 py-2 lg:ml-10 ml-1 mt-1 lg:mt-10 h-12 border-2 text-lg text-cyan-600 lg:hover:bg-cyan-600 lg:hover:text-cyan-200">
          Back
        </button>
      </Link>
      <div className=" grid place-items-center bg-center -mt-7 lg:-mt-0 relative z-50 top-0 w-full h-full">
